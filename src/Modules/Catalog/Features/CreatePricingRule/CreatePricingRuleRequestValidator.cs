...
public sealed class CreatePricingRuleRequestValidator : Validator<CreatePricingRuleRequest>
{
    public CreatePricingRuleRequestValidator()
    {
        ...
        // Whether UnitId refers to a real Unit, and whether this rule
        // overlaps an existing one, are database concerns checked in the
        // handler - same convention as CreateUnitRequestValidator.
    }
}
