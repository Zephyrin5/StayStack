    ...
    : IRequestHandler<HoldAvailabilityRequest, HoldAvailabilityResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            // The database itself rejected the insert - some or all of the
            // requested range is already held/booked for this unit. This
            // IS the double-booking guarantee: no rows-affected check, no
            // manual locking, the constraint does the work. See
