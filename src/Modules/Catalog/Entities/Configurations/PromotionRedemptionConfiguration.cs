...
public class PromotionRedemptionConfiguration : IEntityTypeConfiguration<PromotionRedemption>
{
    public void Configure(EntityTypeBuilder<PromotionRedemption> builder)
    {
        ...
        builder.Property(r => r.DiscountAmount).HasColumnType("numeric(10,2)").IsRequired();
        builder.Property(r => r.Currency).HasConversion<string>().HasMaxLength(3).IsFixedLength().IsRequired();
