...
// path (see Catalog.Contracts' PromotionRedemption implementation), not
...
// goes through EF normally, same split PricingRule already draws for its
// own read-vs-write frequency (see docs/adr/0012), just applied to one
// field here instead of a whole table.
