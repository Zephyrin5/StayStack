...
| `ExpireUnpaidBookingsJob.cs` | Bookings | Bookings, Transactions, Promotions | Transactions is read (succeeded-payment check); Promotions reverses the redemption | The same as cancellation, and the payment check made against a copy or a call |
