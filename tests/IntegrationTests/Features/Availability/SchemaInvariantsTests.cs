...
// it exists only as hand-written SQL inside Catalog's original Initial
// migration's Up() (unit_availability_holds moved to this module later -
// see docs/adr/0004 - but the constraint itself, and the table it lives on,
// never physically moved), with no representation in the C# model at all.
// That means a migration squash/regenerate from the current model would
// silently omit it - nothing else would ever catch that. This test is the
