...
public class BookingTests
{
    ...
    private static Booking CreateValidBooking(Guid? customerId = null)
    {
        return Booking.Create(
            ...
            Today, Today.AddDays(3), 2, Kwd(150m), Kwd(150m), CancellationPolicy.CreateDefault(), "Asia/Kuwait", DateTimeOffset.UtcNow.AddMinutes(30));
    }
    ...
    public void Create_ShouldAllowNullCustomerIdAndNullGuestPhone_ForGuestCheckout()
    {
        Booking booking = Booking.Create(
            ...
            Today, Today.AddDays(1), 1, Kwd(50m), Kwd(50m), CancellationPolicy.CreateDefault(), "Asia/Kuwait", DateTimeOffset.UtcNow.AddMinutes(30));
    ...
    public void Create_ShouldThrow_WhenIdIsEmpty()
    {
        Assert.ThrowsAny<ArgumentException>(() => Booking.Create(
            Guid.Empty, Guid.NewGuid(), Guid.NewGuid(), null, "Jane", "jane@example.com", null, Today, Today.AddDays(1), 1, Kwd(50m), Kwd(50m), CancellationPolicy.CreateDefault(), "Asia/Kuwait", DateTimeOffset.UtcNow.AddMinutes(30)));
    }
    ...
    {
        Assert.ThrowsAny<ArgumentException>(() => Booking.Create(
            Guid.NewGuid(), Guid.Empty, Guid.NewGuid(), null, "Jane", "jane@example.com", null, Today, Today.AddDays(1), 1, Kwd(50m), Kwd(50m), CancellationPolicy.CreateDefault(), "Asia/Kuwait", DateTimeOffset.UtcNow.AddMinutes(30)));
    }
    ...
    {
        Assert.ThrowsAny<ArgumentException>(() => Booking.Create(
            Guid.NewGuid(), Guid.NewGuid(), Guid.Empty, null, "Jane", "jane@example.com", null, Today, Today.AddDays(1), 1, Kwd(50m), Kwd(50m), CancellationPolicy.CreateDefault(), "Asia/Kuwait", DateTimeOffset.UtcNow.AddMinutes(30)));
    }
    ...
    {
        Assert.ThrowsAny<ArgumentException>(() => Booking.Create(
            Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), null, guestName!, "jane@example.com", null, Today, Today.AddDays(1), 1, Kwd(50m), Kwd(50m), CancellationPolicy.CreateDefault(), "Asia/Kuwait", DateTimeOffset.UtcNow.AddMinutes(30)));
    }
    ...
    {
        Assert.ThrowsAny<ArgumentException>(() => Booking.Create(
            Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), null, "Jane", guestEmail!, null, Today, Today.AddDays(1), 1, Kwd(50m), Kwd(50m), CancellationPolicy.CreateDefault(), "Asia/Kuwait", DateTimeOffset.UtcNow.AddMinutes(30)));
    }
    ...
    {
        Assert.ThrowsAny<ArgumentException>(() => Booking.Create(
            Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), null, "Jane", "jane@example.com", null, Today, Today, 1, Kwd(50m), Kwd(50m), CancellationPolicy.CreateDefault(), "Asia/Kuwait", DateTimeOffset.UtcNow.AddMinutes(30)));
    }
    ...
    {
        Assert.ThrowsAny<ArgumentException>(() => Booking.Create(
            Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), null, "Jane", "jane@example.com", null, Today, Today.AddDays(1), guestCount, Kwd(50m), Kwd(50m), CancellationPolicy.CreateDefault(), "Asia/Kuwait", DateTimeOffset.UtcNow.AddMinutes(30)));
    }
    ...
    {
        Assert.ThrowsAny<ArgumentException>(() => Booking.Create(
            Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), null, "Jane", "jane@example.com", null, Today, Today.AddDays(1), 1, Kwd(-1m), Kwd(-1m), CancellationPolicy.CreateDefault(), "Asia/Kuwait", DateTimeOffset.UtcNow.AddMinutes(30)));
    }
